...
function extendMenu(id) {
    ...
    const dropdownImg = document.getElementById('img' + id)

    if(dropdown.classList.contains('h-auto')) {
        dropdown.classList.add('h-14')
        dropdown.classList.remove('h-auto')
        dropdownImg.classList.remove('rotate-90')
        
    } else {
        dropdown.classList.remove('h-14')
        dropdown.classList.add('h-auto')
        dropdownImg.classList.add('rotate-90')
    }
}
</script>
...
<template>
    ...
    <div class="bg-[#F6F6F7] px-4 sm:p-8 md:p-12 xl:px-64 2xl:px-96">
        <div>
            <a class="group overflow-hidden" href="#">
      <div class="flex flex-col">
        <div class="flex-shrink-0 relative h-48 sm:h-64 md:h-96">
          <img class="transition-transform duration-500 ease-in-out w-full h-full absolute top-0 left-0 object-cover drop-shadow-md" src="../assets/Pictures/Baby_header.jpg" alt="Image Description">

        </div>
        

        <!-- <div class="grow mt-4 sm:hidden sm:mt-0 sm:px-0 md:text-center md:p-12">
          ...
          <p class="mt-3 text-gray-600 my-4">
            ...
            <blockquote class="relative mt-8">
                <svg class="ml-2 absolute top-0 left-0 transform -translate-x-6 -translate-y-8 h-12 w-12 text-gray-100 dark:text-gray-700 opacity-10" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="bg-white h-14 rounded-b-md font-medium border-b-2 overflow-hidden ">
            <div class="flex justify-between items-center h-14 w-full cursor-not-allowed">
                <p class="m-2 font-medium text-gray-600">Coming soon</p>
                <img class="w-4 h-4 mr-4" src="../assets/Pictures/icons8-arrow-30.png"  alt="">
            </div>
        </div>
        <div class="bg-white h-14 rounded-b-md font-medium border-b-2 overflow-hidden ">
            <div class="flex justify-between items-center h-14 w-full cursor-not-allowed">
